...
foreach($array["hits"] as $hits){
	...
	function get_data($query) {
		...
		$request_url = $this -> 'http://api.nutritionix.com/v1_1/search/'.$query.'?results=0%3A1&cal_min=0&cal_max=50000&fields=nf_total_carbohydrate%2Cnf_protein%2Cnf_total_fat%
